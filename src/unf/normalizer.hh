...
namespace UNF {
  ...
  public:
    Normalizer()
      : nf_d(TABLE::CANONICAL_DECOM_NODES, TABLE::NODES, TABLE::CANONICAL_DECOM_ROOT, TABLE::VALUES, TABLE::VALUE),
	nf_kd(TABLE::COMPATIBILITY_DECOM_NODES, TABLE::NODES, TABLE::COMPATIBILITY_DECOM_ROOT, TABLE::VALUES,TABLE::VALUE),
	nf_c(TABLE::CANONICAL_COM_NODES, TABLE::NODES, TABLE::CANONICAL_COM_ROOT, TABLE::VALUES,TABLE::VALUE),
	nf_c_qc(TABLE::NFC_ILLEGAL_NODES, TABLE::NODES, TABLE::NFC_ILLEGAL_ROOT, TABLE::VALUES),
	nf_kc_qc(TABLE::NFKC_ILLEGAL_NODES, TABLE::NODES, TABLE::NFKC_ILLEGAL_ROOT, TABLE::VALUES),
	ccc(TABLE::CANONICAL_CLASS_NODES, TABLE::NODES, TABLE::CANONICAL_CLASS_ROOT, TABLE::VALUES)
    {}
